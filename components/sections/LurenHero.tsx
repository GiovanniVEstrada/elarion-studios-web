...
export default function LurenHero() {
  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-luren-surface px-6 pt-20 pb-16 sm:pt-32 sm:pb-24">
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        <motion.h1
          ...
          style={{ fontSize: "clamp(1.9rem, 6vw, 3.6rem)", lineHeight: 1.18 }}
          initial={{ opacity: 0, y }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.p
          className="mx-auto mb-8 max-w-xl text-base font-light leading-relaxed text-luren-body sm:mb-10 sm:text-lg"
          initial={{ opacity: 0, y }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              href="#"
              className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-luren-cyan/50 px-7 py-3 text-sm font-medium uppercase tracking-widest text-luren-cyan transition-all duration-300 hover:border-luren-cyan hover:bg-luren-cyan/10 sm:w-auto"
